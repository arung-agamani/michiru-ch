...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AddPredefinedTemplateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects/{projectID}/templates/event-type/{eventType}": {
            "get": {
    ...
    "definitions": {
        "handlers.AddPredefinedTemplateRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
